...
class TicketShow extends Component
{
    ...
    public function startTicket(TicketStatusAction $action)
    {
        try {
            ...
            $this->success(__('toast.ticket_started', ["id" => $this->ticket->id]));
    ...
    public function closeTicket(TicketStatusAction $action)
    {
        try {
            ...
            $this->success(__('toast.ticket_closed'), ["id" => $this->ticket->id]);
        } catch (AuthorizationException) {
    ...
    public function reopenTicket(TicketStatusAction $action)
    {
        try {
            ...
            $this->success(__('toast.ticket_reopened'), ["id" => $this->ticket->id]);
        } catch (AuthorizationException) {
